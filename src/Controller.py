...
class Controller:
    def __init__(self, width = 640, height = 480):
        ...
        self.pinky1 = Ghost.Pinky('assets/pinky.png',random.randint(1,31)*20,random.randint(1,23)*20,20)
        self.pinky2 = Ghost.Pinky('assets/pinky.png',random.randint(1,31)*20,random.randint(1,23)*20,20)
        self.pinkyGroup = pygame.sprite.Group(self.pinky1,self.pinky2)
        self.cherry = Powerup.Cherry('assets/cherry.png',random.randint(1,31)*20,random.randint(1,23)*20)
        self.cherryGroup = pygame.sprite.Group(self.cherry)
        self.banana = Powerup.Banana('assets/banana.png',random.randint(1,31)*20,random.randint(1,23)*20)
        self.bananaGroup = pygame.sprite.Group(self.banana)
        self.snowflake = Powerup.Snowflake('assets/snowflake.png',random.randint(1,31)*20,random.randint(1,23)*20)
        self.snowflakeGroup = pygame.sprite.Group(self.snowflake)
        self.powerpellet = Powerup.Powerpellet('assets/powerpellet.png',random.randint(1,31)*20,random.randint(1,23)*20)
